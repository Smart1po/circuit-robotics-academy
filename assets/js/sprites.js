...
(function (global) {
  ...
  /* --- The mark: a big silver wing ----------------------------------------
   * Spread when the lights are on, folded shut when they are off.
   *
   * It has its own palette because it is the only silver thing on the site —
   * everything else is painted in the academy's indigo. A two-pixel specular
   * band sweeps across the metal every few seconds and is gone again, which
   * is the only honest way to make pixels look polished: light moving over a
   * surface, not a gradient baked into it.
   * 28 x 14.
   * --------------------------------------------------------------------- */
  var SILVER = {
    o: '#232730',   /* steel outline        */
    k: '#4C5462',   /* the groove between feathers */
    m: '#8A93A3',   /* mid silver           */
    l: '#BFC8D6',   /* light silver         */
    h: '#E6ECF6',   /* bright silver        */
...
var WING_OPEN_FRAMES = [
    [
      ...
      '........oohhllllhhoo........',
      '......oohhllmmmmllhhoo......',
      '....oohhllmmmmmmmmllhhoo....',
      '..oohhllmmmmmmmmmmmmllhhoo..',
      'oohhllmmmkmmmkmmmkmmmmllhhoo',
      'ohhllmmmkmmmkmmmkmmmkmmllhho',
      'ohllmmmkmmmmkmmmmkmmmmkmllho',
      '.ohlmmkmmmmkmmmmkmmmmkmmlho.',
      '..ohllmmkmmmkmmmkmmmkmllho..',
      '....oohhllmmmmmmmmllhhoo....',
      '........oohhllllhhoo........',
      '............oooo............'
    ],
    ...
    [
      ...
      '..oohhllmmmmmmmmmmmmllhhoo..',
      'oohhllmmmkmmmkmmmkmmmmllhhoo',
      'owwllmmmkmmmkmmmkmmmkmmllhho',
      'ohwwmmmkmmmmkmmmmkmmmmkmllho',
      '.ohwhmkmmmmkmmmmkmmmmkmmlho.',
      '..ohwwmmkmmmkmmmkmmmkmllho..',
      '....oowhllmmmmmmmmllhhoo....',
      '........oohhllllhhoo........',
      '............oooo............'
    ],
    [
      ...
      '......oohhllmmmmllhhoo......',
      '....oohhllmmmmmmmmllhhoo....',
      '..oowhllmmmmmmmmmmmmllhhoo..',
      'oohhwwmmmkmmmkmmmkmmmmllhhoo',
      'ohhllhhmkmmmkmmmkmmmkmmllhho',
      'ohllmmhkmmmmkmmmmkmmmmkmllho',
      '.ohlmmkhhmmkmmmmkmmmmkmmlho.',
      '..ohllmmkhmmkmmmkmmmkmllho..',
      '....oohhlwhmmmmmmmllhhoo....',
      '........oowwllllhhoo........',
      '............oooo............'
    ],
    [
      ...
      '........oohhllllhhoo........',
      '......oohhllmmmmllhhoo......',
      '....oowwllmmmmmmmmllhhoo....',
      '..oohhlwhmmmmmmmmmmmllhhoo..',
      'oohhllmmhkmmmkmmmkmmmmllhhoo',
      'ohhllmmmkhhmkmmmkmmmkmmllhho',
      'ohllmmmkmmhhkmmmmkmmmmkmllho',
      '.ohlmmkmmmmkhmmmkmmmmkmmlho.',
      '..ohllmmkmmmkhmmkmmmkmllho..',
      '....oohhllmmmhhmmmllhhoo....',
      '........oohhllwwhhoo........',
      '............oooo............'
    ],
    [
      ...
      '........oohhllllhhoo........',
      '......oohwwlmmmmllhhoo......',
      '....oohhllhhmmmmmmllhhoo....',
      '..oohhllmmmhhmmmmmmmllhhoo..',
      'oohhllmmmkmmhkmmmkmmmmllhhoo',
      'ohhllmmmkmmmkhhmkmmmkmmllhho',
      'ohllmmmkmmmmkmhhmkmmmmkmllho',
      '.ohlmmkmmmmkmmmhkmmmmkmmlho.',
      '..ohllmmkmmmkmmmkhmmkmllho..',
      '....oohhllmmmmmmmhwlhhoo....',
      '........oohhllllhhoo........',
      '............oooo............'
    ],
    [
      ...
      '........oohhwwllhhoo........',
      '......oohhllmhhmllhhoo......',
      '....oohhllmmmmhhmmllhhoo....',
      '..oohhllmmmmmmmhhmmmllhhoo..',
      'oohhllmmmkmmmkmmhkmmmmllhhoo',
      'ohhllmmmkmmmkmmmkhhmkmmllhho',
      'ohllmmmkmmmmkmmmmkhhmmkmllho',
      '.ohlmmkmmmmkmmmmkmmhhkmmlho.',
      '..ohllmmkmmmkmmmkmmmkhllho..',
      '....oohhllmmmmmmmmllhwoo....',
      '........oohhllllhhoo........',
      '............oooo............'
    ],
    [
      ...
      '........oohhllllwwoo........',
      '......oohhllmmmmlwwhoo......',
      '....oohhllmmmmmmmmwwhhoo....',
      '..oohhllmmmmmmmmmmmhwlhhoo..',
      'oohhllmmmkmmmkmmmkmmhhllhhoo',
      'ohhllmmmkmmmkmmmkmmmkhhllhho',
      'ohllmmmkmmmmkmmmmkmmmmkhllho',
      '.ohlmmkmmmmkmmmmkmmmmkmhwho.',
      '..ohllmmkmmmkmmmkmmmkmllwo..',
      '....oohhllmmmmmmmmllhhoo....',
      '........oohhllllhhoo........',
      '............oooo............'
    ],
    [
      ...
      '......oohhllmmmmllhhoo......',
      '....oohhllmmmmmmmmllhhoo....',
      '..oohhllmmmmmmmmmmmmllhwoo..',
      'oohhllmmmkmmmkmmmkmmmmllwwoo',
      'ohhllmmmkmmmkmmmkmmmkmmllwwo',
      'ohllmmmkmmmmkmmmmkmmmmkmllwo',
      '.ohlmmkmmmmkmmmmkmmmmkmmlho.',
      '..ohllmmkmmmkmmmkmmmkmllho..',
      '....oohhllmmmmmmmmllhhoo....',
      '........oohhllllhhoo........',
...
var WING_SHUT_FRAMES = [
  ...
  var CAST = {
    ...
    'wing-open': { frames: WING_OPEN_FRAMES, palette: SILVER, fps: 8, scale: 3 },
    'wing-shut': { frames: WING_SHUT_FRAMES, palette: SILVER, fps: 8, scale: 3 },
